...
namespace Traveler\Infrastructure\Models\City\Map;
...
class CityTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'City.Map.CityTableMap';
     ...
     */
    public const OM_CLASS = '\\Traveler\\Infrastructure\\Models\\City\\City';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'City.City';
     ...
     */
    public const COL_ID = 'cities.id';

    /**
     * the column name for the name field
     */
    public const COL_NAME = 'cities.name';
    ...
    protected static $fieldNames = [
        ...
        self::TYPE_COLNAME       => [CityTableMap::COL_ID, CityTableMap::COL_NAME, ],
    ...
    protected static $fieldKeys = [
        ...
        self::TYPE_COLNAME       => [CityTableMap::COL_ID => 0, CityTableMap::COL_NAME => 1, ],
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\Traveler\\Infrastructure\\Models\\City\\City');
        $this->setPackage('City');
    ...
    {
        $this->addRelation('Sight', '\\Traveler\\Infrastructure\\Models\\Sight\\Sight', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':city_id',
    1 => ':id',
  ),
), null, null, 'Sights', false);
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Traveler', '\\Traveler\\Infrastructure\\Models\\Traveler\\Traveler', RelationMap::MANY_TO_MANY, array(), null, null, 'Travelers');
    }
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(CityTableMap::COL_ID);
            $criteria->removeSelectColumn(CityTableMap::COL_NAME);
        } else {
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Traveler\Infrastructure\Models\City\City) { // it's a model object
